...
from src.author_mapping.scripts import map_abbreviations_to_names
...
class TestMapAbbreviationsToNames(TestCase):
    ...
    def setUp(self):
        ...
        map_abbreviations_to_names.get_db_connection = Mock(return_value=(self.con, self.cur))
        map_abbreviations_to_names.DEPARTMENT_THRESHOLD = 0
        map_abbreviations_to_names.SMALL_DEPARTMENT_NUMBER_PENALTY_Y_INTERSECT = 0
        map_abbreviations_to_names.SMALL_DEPARTMENT_NUMBER_PENALTY_SLOPE = 0
    ...
    def test_get_data_for_department_score(self):
        department_affiliation = map_abbreviations_to_names.get_data_for_department_score(self.cur)
    ...
    def test_prepare_data_for_department_score(self):
        ...
        department_affiliation = map_abbreviations_to_names.prepare_data_for_department_score(department_affiliation)
    ...
    def test_scale_department_count(self):
        ...
        department_count_scaled = map_abbreviations_to_names.scale_department_count(department_count, department_scaler_score, "abbreviation_share")
    ...
    def test_calculate_department_score(self):
        results = map_abbreviations_to_names.calculate_department_score(self.cur)
